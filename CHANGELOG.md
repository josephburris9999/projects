...
- Renamed plug-ins, features, packages, and update-site metadata to `com.all9ssolutions.*`.
- Updated vendor and user-facing references to all9s Solutions.
- Added command image metadata for editor context-menu icons.
